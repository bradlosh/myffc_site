...
module.exports = function(options) {
  var collectionName, destination, limit, customElements
  ...
  subtitle = options.subtitle || 'Faith Family Church, Taylors, SC'
  customElements = options.custom_elements
